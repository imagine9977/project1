...
<body>
	...
	<div class="content">
		<div id="bank" class="section">
			...
			<div class="col-sm-9">
				...
				<p>방학동 은행나무(放學洞 銀杏나무)는 서울특별시 지정보호수 제1호(1968.2.26.) 및 서울특별시 기념물
					...
					신성시하였고, 이 곳에 불이 날 때마다 나라에 큰 변이 생겼다고 하는 일화가 지금까지도 전해지고 있다. 박정희 전
					대통령이 서거하기 일년 전에도 불이 나서 소방차가 동원되어 진화했다고 한다. 도봉구에서는 은행나무의 생육환경을 조성하기
					위해 인근 아파트 단지가 조성될 때 나무의 생육에 지장을 주지 않도록 아파트 구조를 변경하였으며, 그 후 은행나무 인근에
		...
		<div id="oldhouse" class="section">
			...
			<div class="row" style="padding-bottom: 40px;">
				<div class="col">
					<img src="${hpath}/images/oldHouse.jpg" alt="gansong"
						style="height: 400px">
				</div>
				<div class="col">
					<iframe
