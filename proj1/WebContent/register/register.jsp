											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<div class="form-outline flex-fill mb-0">
													<input type="email" id="form3Example3c"
														...
														for="form3Example3c">이메일 주소</label>
												</div>
											</div>
											...
											<div class="d-flex flex-row align-items-center mb-4">
												...
												<div class="form-outline flex-fill mb-0">
													<input type="password" id="form3Example4cd"
														class="form-control" /> <label class="form-label"
														for="form3Example4cd">비밀번호 확인</label>
												</div>
											</div>
											<div class="custom-control custom-checkbox mb-3">
												<input type="checkbox" class="custom-control-input"
													id="customControlValidation1" required> <label
													class="custom-control-label" for="customControlValidation1">나는 <a
													href="#!">약관에</a> 모두 동의한다.</label>
												<div class="invalid-feedback">약관에 동의해주십시오</div>
											</div>
